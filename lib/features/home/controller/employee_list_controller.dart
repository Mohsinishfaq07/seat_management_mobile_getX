import 'package:ais_seat_management_system/core/error/failures.dart';
...
import 'package:ais_seat_management_system/features/home/model/get_all_employees.dart';
import 'package:ais_seat_management_system/features/home/model/get_assigned_assets.dart';
import 'package:ais_seat_management_system/features/home/model/get_assigned_employees.dart';
import 'package:ais_seat_management_system/features/home/model/get_unassigned_employees.dart';
...
class EmployeeListController extends GetxController {
  ...
  Future<void> assignAssetToEmployees(String assetId, String assetName, String assetType, String assetLocation) async {
    var response = await homeDataSource.assignAssets(assetId, selectedEmployeeID, assetName, assetType, assetLocation);
    if (response is Failure) {
      handleError(response);
    } else {
  ...
  //- ASSIGN ASSETS TO EMPLOYEES
  Future<void> assignAssetToEmployee(String assetId, String assetName, String assetType, String assetLocation) async {
