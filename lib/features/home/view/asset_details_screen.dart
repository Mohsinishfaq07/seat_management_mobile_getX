...
import 'package:ais_seat_management_system/core/widgets/primary_continuebutton.dart';
import 'package:ais_seat_management_system/features/home/view/widgets/add_asset_widget.dart';
...
import 'package:ais_seat_management_system/features/home/view/widgets/asset_detail_tile.dart';
              ...
              children: [
                ...
                GetBuilder<AssetsController>(
                  builder: (controller) {
                    return Column(
                      children: [
                        for (int i = 0; i <= assetsController.addNewAssetsRecordData.length - 1; i++)
                          AddAssetWidget(
                        ...
                        GestureDetector(
                          onTap: () {
                            Logger().i(
                                assetsController.addAssetsWidgetList.length);
                            assetsController.addNewWidgetToList(
                                AddAssetWidget(
                                    assetsController: assetsController));
                          },
                          child: Container(
                            decoration: BoxDecoration(border: Border.all(color: AppTheme.primaryColor),borderRadius: BorderRadius.circular(20.r)),
